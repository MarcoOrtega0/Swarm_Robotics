...
def auto(pub):
	...
	while mode=='a':
		if isNewData:
			...
			if(ro>0.15): # if you are not close to the target go with constant speed, otherwise not
				const=v/w
				v_const=0.2
...
if __name__ == "__main__":
	...
	pub = rospy.Publisher('robot1/cmd_vel', Twist, queue_size = 3)
	...
	while True:
		...
		if input_task in ['a','m','e']:
			...
			try:
				...
				in2 = float(in2)
				if(mode=='a'):
					theta_g = input("Provide orientation of the robot in degrees: ")
